...
class tem_dense(nn.Module):
    ...
    def __init__(self, num_classes, model_name, pretrain_choice, seq_len):
        ...
        self.cat_conv1 = nn.Conv1d(in_channels=2, out_channels=1, kernel_size=1)
        self.cat_conv2 = nn.Conv1d(in_channels=3, out_channels=1, kernel_size=1)
        self.cat_conv3 = nn.Conv1d(in_channels=4, out_channels=1, kernel_size=1)
    ...
    def forward(self, x, pids=None, camids=None):
        ...
        if self.training:
            ...
            return feature_3, BN_feature, pids, camids